...
class ViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func ColorKey(num: Int){
        ...
        case -12,0,12:                                  //if 0 (mod 12)
            C.backgroundColor = UIColor.red       //Color C
        case -11,1,13:                                  //if 1 (mod 12)
            CD.backgroundColor = UIColor.red      //Color C#
        case -10,2,14:                                  //if 2 (mod 12)
            D.backgroundColor = UIColor.red       //Color D
        case -9,3,15:                                   //if 3 (mod 12)
            DE.backgroundColor = UIColor.red      //Color D#
        case -8,4,16:                                   //if 4 (mod 12)
            E.backgroundColor = UIColor.red       //Color E
        case -7,5,17:                                   //if 5 (mod 12)
            F.backgroundColor = UIColor.red       //Color F
        case -6,6,18:                                   //if 6 (mod 12)
            FG.backgroundColor = UIColor.red      //Color F#
        case -5,7,19:                                   //if 7 (mod 12)
            G.backgroundColor = UIColor.red       //Color G
        case -4,8,20:                                   //if 8 (mod 12)
            GA.backgroundColor = UIColor.red      //Color G#
        case -3,9,21:                                   //if 9 (mod 12)
            A.backgroundColor = UIColor.red       //Color A
        case -2,10,22:                                  //if 10 (mod 12)
            AB.backgroundColor = UIColor.red      //Color A#
        case -1,11,23:                                  //if 11 (mod 12)
            B.backgroundColor = UIColor.red       //Color B
    ...
    func ModifyKeys(key: String, scale: String){      
        ...
        if key == "C"{                              //If C is key
            ...
            C.backgroundColor = UIColor.green    //color C into darkGray
        }else if key == "C#/Db" {                   //If C# is key
            ScaleType(root: 1)                      //C# is now root
            CD.backgroundColor = UIColor.green   //color C# into darkGray
        }else if key == "D" {                       //If D is key
            ScaleType(root: 2)                      //D is now root
            D.backgroundColor = UIColor.green    //color D into darkGray
        }else if key == "D#/Eb" {                   //If D# is key
            ScaleType(root: 3)                      //D# is now root
            DE.backgroundColor = UIColor.green   //color D# into darkGray
        }else if key == "E" {                       //If E is key
            ScaleType(root: 4)                      //E is now root
            E.backgroundColor = UIColor.green    //color E into darkGray
        }else if key == "F" {                       //If F is key
            ScaleType(root: 5)                      //F is now rgroot
            F.backgroundColor = UIColor.green    //color F into darkGray
        }else if key == "F#/Gb" {                   //If F# is key
            ScaleType(root: 6)                      //F# is now root
            FG.backgroundColor = UIColor.green   //color F# into darkGray
        }else if key == "G" {                       //If G is key
            ScaleType(root: 7)                      //G is now root
            G.backgroundColor = UIColor.green    //color G into darkGray
        }else if key == "G#/Ab" {                   //If G# is key
            ScaleType(root: 8)                      //G# is now root
            GA.backgroundColor = UIColor.green   //color G# into darkGray
        }else if key == "A" {                       //If A is key
            ScaleType(root: 9)                      //A is now root
            A.backgroundColor = UIColor.green    //color A into darkGray
        }else if key == "A#/Bb" {                   //If A# is key
            ScaleType(root: 10)                     //A# is now root
            AB.backgroundColor = UIColor.green   //color A# into darkGray
        }else if key == "B" {                       //If B is key
            ScaleType(root: 11)                     //B is now root
            B.backgroundColor = UIColor.green    //color B into darkGray
        }
    }
